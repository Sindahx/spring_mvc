...
//			str = gson.toJson(uploadRes);
			writeSponse(response, str);
			return;
		}
...
//					System.out.println("上传的文件的扩展名是：" + fileExtName);
					...
					String realSavePath = makePath(saveFilename, savePath, datedir);
					// 创建一个文件输出流
...
//			str = gson.toJson(uploadRes);
	 ...
	 * @return 新的存储目录
	 */
	private String makePath(String filename, String savePath, String datedir) {
